...
test_find_substring()
{
    ...
    for var in ${@:3} ; do
        EXPECTED_OUTPUT+="Substring found at index: $var\n"
    done
    EXPECTED_OUTPUT=$(printf "$EXPECTED_OUTPUT")
...
test_find_substring_1()
{
    test_find_substring "ABCABCBABCBABCBBBABABBCBABCBAAACCCB" "BABC" 6 10 23
}
test_find_substring_2()
{
    test_find_substring "This is a test" "for no occurrences"
}
test_find_substring_3()
{
    test_find_substring "baaanaaanaaaa" "aa" 1 2 5 6 9 10 11
}
test_find_substring_4()
{
    test_find_substring "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar. The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way." "in" 17 36 106 137 341 381 422 425 456 527 536 762 827 835
}

run_test "test_find_substring_1" 25
run_test "test_find_substring_2" 25
run_test "test_find_substring_3" 25
run_test "test_find_substring_4" 25
